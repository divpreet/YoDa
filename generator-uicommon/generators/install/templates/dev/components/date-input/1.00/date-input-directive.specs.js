describe('appname.common', function() {
	...
	// Load the module, which contains Date-input
	...
	describe('display parameter myParam', function() {
		...
		it('display "Hello world" when my-param="Hello world"', function() {
			// Compile a piece of HTML containing Date-input
			var element = $compile('<appname-date-input my-param="Hello world"></appname-date-input>')($rootScope);
